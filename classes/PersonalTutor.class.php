...
/**
 * Core class to define all Personal Tutor related methods, such as checking if a user is a PT of a 
 * given student, adding students/courses/groups to a PT, etc...
 * 
