 ...
 * @author cwarwicker
 */
class multifield extends \block_df_dashboard\Report\Element {
    ...
    public function __construct($params = null) {
        ...
        $this->options = array(
            ...
            array('multiselect', get_string('reportoption:fields', 'block_df_dashboard'), array()), # Fields to combine
            array('select', get_string('reportoption:groupby', 'block_df_dashboard'), array()), # Field to group by
            array('text', get_string('reportoption:groupbyvalue', 'block_df_dashboard'), ''), # Value to group by
