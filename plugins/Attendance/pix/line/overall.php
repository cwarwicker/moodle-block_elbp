...
// It would make more sense to remove the TOtal period from this as it's charting progress from period to period
$__periods = array_diff( $__periods, array("Total") );
