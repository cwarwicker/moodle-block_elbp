<?php
/**
 * Firebird Database Manager Class
 * 
 * Handles connection to and querying of Firebird databases when using an MIS Connection
 * 
...
class Firebird extends Manager {
    ...
    public function __construct($params = null) {
        ...
        if (extension_loaded('pdo_firebird')) $this->extension = 'pdo_firebird';
    ...
    public function select($table, $where = null, $fields = "*", $order = null, $limit = null){
        ...
        $sql .= " SELECT ";
            if (!is_null($limit)) $sql .= " FIRST {$limit} ";
        $sql .= " {$fields} ";
