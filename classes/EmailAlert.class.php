...
class EmailAlert extends Alert {
     ...
     */
    public function runStudent($eventName, $pluginID, $studentID, $content, $htmlContent) {

        global $DB;

        if (\block_elbp\Setting::getSetting('enable_email_alerts') != 1) {
            return false;
        }
     ...
     * @return boolean
     */
    public function run($eventName, $pluginID, $studentID, $content, $htmlContent, $confidentialityLevel = null) {
            ...
            foreach ($courses as $course) {
                ...
                if ($users) {
                    ...
                    foreach ($users as $user) {
                        ...
                        if (isset($this->alertedUsers[$user->id]) && $this->alertedUsers[$user->id] == true) {
                            continue;
                        }
