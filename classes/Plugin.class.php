...
abstract class Plugin {
    ...
    static public function instaniate($pluginName, $pluginPath = null, $install = true) {
        ...
        } else if ( is_file($CFG->dirroot . $pluginPath) ) {
        ...
        } else if ( preg_match("/\.php/", $pluginPath) ) {
    ...
    */
     ...
     */
    abstract public function getSummaryBox();

    /**
     * Run an AJAX call
     */
    abstract public function ajax($action, $params, $ELBP);
