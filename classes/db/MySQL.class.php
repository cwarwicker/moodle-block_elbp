...
// TODO: This is kind of pointless, as I could just use the core moodle database API which supports MySQL.
...
class MySQL extends Manager {
    ...
    public function getTableInfo($tableName = null, $tablePrefix = null) {
        ...
        if (is_null($tableName) && is_null($tablePrefix)) {
            return false;
        }
