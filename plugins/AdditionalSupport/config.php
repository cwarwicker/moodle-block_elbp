...
/**
 * Configure the Additional Support plugin
 * 
...
try {
    $OBJ = \ELBP\Plugins\Plugin::instaniate("AdditionalSupport");
...
$PAGE->set_title( get_string('additionalsupportconfig', 'block_elbp') );
