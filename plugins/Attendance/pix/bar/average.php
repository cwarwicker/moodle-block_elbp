...
$__width = count($__types) * 100;
$__graph_width = $__width - 100;
$__graph_x2 = 50 + $__graph_width;
$__values = array();
foreach($__types as $type)
{
    $val = $attendanceObject->getRecord( array("period"=>null, "type"=>$type) );
...
$myData->addPoints($__values,"Serie1");
$myData->setSerieDescription("Serie1",get_string('average', 'block_elbp'));
$myData->setSerieOnAxis("Serie1",0);

$myData->addPoints($__types,"Absissa");
...
$myPicture = new pImage($__width,230,$myData);
...
$myPicture->drawGradientArea(0,0,$__width,230,DIRECTION_VERTICAL,$Settings);

$myPicture->drawRectangle(0,0, ($__width - 1) ,229,array("R"=>0,"G"=>0,"B"=>0));
...
, "R"=>0, "G"=>0, "B"=>0);
$myPicture->drawText(150,25,get_string('average', 'block_elbp'),$TextSettings);

$myPicture->setShadow(FALSE);
$myPicture->setGraphArea(50,50,$__graph_x2,190);
