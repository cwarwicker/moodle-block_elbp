 ...
 * Custom Plugins
 * 
 * Class to use to build up custom plugins that don't have their own code - Just built from a set of 
 * attributes and settings to display information.
 * 
 * Types of custom plugins you can make:
 *  - Simple forms - use the normal form element attributes and save/display those results
 *      - Single, Multiple, Incremental
 *  - Internal data - define an SQL query to execute on your db, cols being returned, how to display them, etc...
 *  - External data - same as internal, but using an MIS connection to query another db
 * 
